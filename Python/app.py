...
def make_account():
    try:
        ...
        target.functions.setUserDetails(acc1, "Master", f'https://firebasestorage.googleapis.com/v0/b/blockchain-upi.appspot.com/o/images%2F1712479801720?alt=media&token=3217d36f-e8b3-45da-bccc-56183bec0301').transact({'from': acc1})
...
def buy_coin():
    try:
        ...
        transaction_hash = web3.to_hex(tx_hash)
        target.functions.setUserDetails(master_address, "Crypto Bought", f'https://firebasestorage.googleapis.com/v0/b/blockchain-upi.appspot.com/o/images%2F1712479881289?alt=media&token=23d6e1c8-9128-4fae-bee8-4cae421f0130').transact({'from': master_address})
...
if __name__ == '__main__':
    app.run(host='192.168.43.186', debug=True)
